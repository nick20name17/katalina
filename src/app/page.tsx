                ...
                <Card className="w-full bg-[#FAF6F1] border-2 border-primary/30  break-inside-avoid shadow-lg relative  z-10">
                    ...
                    <CardFooter className="pt-6">
                        <CreateInvoiceBtn
                            ...
                            comment="Доступ до Урок «Captions Design»"
                            destination="Доступ до Урок «Captions Design»"
                        />
                    </CardFooter>
                </Card>
                <Card className="w-full bg-[#FAF6F1] border-2 border-primary/30  break-inside-avoid shadow-lg relative  z-10">
                    ...
                    <CardHeader className="text-center space-y-4 pb-6">
                        <div className="space-y-2">
                            <CardTitle
                                ...
                                Урок-туторіал «Анімаційний дизайн»
                            </CardTitle>
                        </div>
                        <div className="flex items-end justify-center space-x-1 relative">
                            <span className="text-lg line-through text-slate-500">
                    ...
                    <CardFooter className="pt-6">
                        <CreateInvoiceBtn
                            ...
                            comment="Доступ до Урок-туторіал «Анімаційний дизайн»"
                            destination="Доступ до Урок-туторіал «Анімаційний дизайн»"
                        />
                    </CardFooter>
                </Card>
            </div>
