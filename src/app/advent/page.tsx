      ...
      <section className='container mt-12 space-y-5 overflow-x-clip [&_a]:transition-transform [&_a]:hover:scale-105 [&_a]:active:scale-105'>
        ...
        <div className='flex justify-between gap-6 [&_a]:block'>
          ...
          <div className='relative top-8 -left-8'>
            <Link
              className='relative left-2 shrink-0'
              href='https://striped-coyote-b75.notion.site/Advent-Calendar-for-creators-15-23-2cdf155d9ba580838a1fd3c02c487237?source=copy_link'
              target='_blank'
            >
              <Image
            ...
            <Link
              className='absolute top-14 -right-6 shrink-0 -rotate-20'
              href='https://striped-coyote-b75.notion.site/Advent-Calendar-for-Creators-16-23-2cdf155d9ba580be8289e49829d490be?source=copy_link'
              target='_blank'
            >
              <Image
        ...
        <div className='relative flex justify-between gap-6 [&_a]:block'>
          <Link
            target='_blank'
            className='relative left-20 shrink-0 rotate-20'
            href='https://striped-coyote-b75.notion.site/Advent-Calendar-for-creators-17-23-2cff155d9ba580ac8f38c99f06748f8f'
          >
            <Image
          ...
          <Link
            className='relative top-12 -left-20 shrink-0'
            href='https://striped-coyote-b75.notion.site/Advent-Calendar-for-creators-19-23-2d3f155d9ba580eb87f3d1db88022ade?source=copy_link'
            target='_blank'
          >
            <Image
